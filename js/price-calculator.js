...
(function () {
  ...
  function renderFeatureCategories() {
                            ...
                            ${featuresInCategory
                              .map((feature) => {
                                const featureKey = Object.keys(
                                  plusFeatures,
                                ).find((key) => plusFeatures[key] === feature);
                                return `
    ...
    const categoryHeaders =
      categoriesContainer.querySelectorAll(".category-header");
    categoryHeaders.forEach((header) => {
      header.addEventListener("click", function () {
        ...
        features.style.display = category.classList.contains("expanded")
          ? "block"
          : "none";
  ...
  function updatePriceBreakdown(breakdownElement) {
    ...
    Object.keys(featuresByCategory).forEach((category) => {
      ...
      const categoryTotal = features.reduce(
